...
_libraries = {}
# Try to use local folder librarie first
libLoadFile = os.path.dirname(__file__) + "/libftd2xx.so"
if not os.path.isfile(libLoadFile):
    libLoadFile = "libftd2xx.so"
_libraries["libftd2xx.so"] = CDLL(libLoadFile)
STRING = c_char_p
